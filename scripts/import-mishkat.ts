/**
 * Import Mishkat al-Masabih from AhmedBaset/hadith-json v1.2.0.
 * Source has ~89 hadiths (subset from sunnah.com). collection_key: mishkat
 */
...
const CDN = 'https://cdn.jsdelivr.net/gh/AhmedBaset/hadith-json@v1.2.0/db/by_book/other_books/mishkat_almasabih.json';
const RAW = 'https://raw.githubusercontent.com/AhmedBaset/hadith-json/v1.2.0/db/by_book/other_books/mishkat_almasabih.json';
const COLLECTION_KEY = 'mishkat';
const BATCH = 200;
...
async function main() {
  console.log('=== Import Mishkat al-Masabih — AhmedBaset/hadith-json v1.2.0 ===\n');
  ...
  console.log(`Total mishkat in DB: ${total}`);
}
